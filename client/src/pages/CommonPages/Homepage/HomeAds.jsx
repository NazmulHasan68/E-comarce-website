...
export default function HomeAds({}) {
  return (
    <div className="relative md:h-[180px] h-[150px] max-w-7xl mx-auto rounded-lg overflow-hidden shadow-lg">
      {/* Background Image */}
      <img
        src={imageUrl}
        alt={title}
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-start px-6 md:px-12 text-white">
        ...
        <p className="text-xs md:text-sm max-w-lg drop-shadow-md w-[80%] line-clamp-2">
          {description}
        </p>
        <Link
          to={linkUrl}
